local function get_jdtls()
  ...
  -- Declare white operating system we are using, windows use win, macos use mac/mac_arm, and linux uses linux
...
local function get_workspace()
  ...
  -- local workspace_path = home .. "//Documents/Coding/Java/Projects/"
...
local function setup_jdtls()
  ...
  -- Extend the capabilities with the lsp_capabilities
  capabilities = vim.tbl_extend("force", capabilities, lsp_capabilities)
